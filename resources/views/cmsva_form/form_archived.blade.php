...
<div class="d-flex justify-content-between align-items-center mb-4 px-2 py-2 bg-light rounded-3 shadow-sm border">
 ...
 <a href="{{ route('dashboard') }}" class="btn btn-info d-flex align-items-center">
    <i class="bi bi-archive-fill me-2"></i><-Back
</a>
</div>
                        ...
                        <tr>
                            ...
                            <td>
                              <button class="btn btn-sm btn-primary me-1 view-btn" 
                                ...
                                <button class="btn btn-sm btn-success delete-btn" data-id="{{ $material->id }}">Restore</button>
                            </td>
                        </tr>
                        @endforeach
                        <!-- Add more rows here -->
  ...
  document.addEventListener('DOMContentLoaded', function () {
    document.querySelectorAll('.delete-btn').forEach(button => {
      button.addEventListener('click', function () {
        ...
        Swal.fire({
          title: 'Are you sure?',
          text: "This data can be restored!",
          icon: 'info',
          ...
          if (result.isConfirmed) {
            fetch(`/restoreArchived/${material_id}`, {
              method: 'POST',
              headers: {
